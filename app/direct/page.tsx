...
const HOW_IT_WORKS = [
  { step: '01', title: 'Share one door, not your email', copy: 'Replace scattered contact details with a single public Direct page — your access layer between the outside world and your private channels.' },
  { step: '02', title: 'Ask for the right details upfront', copy: 'Budget, scope, timeline — every request arrives structured before you spend a second reviewing.' },
  { step: '03', title: 'Let Direct filter what reaches you', copy: 'Qualified requests go through. Vague, irrelevant, or spammy inbound is stopped at the door.' },
] as const;
